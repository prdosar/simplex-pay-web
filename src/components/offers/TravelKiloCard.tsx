...
export default function TravelKiloCard({ offer, isAuthenticated, locale }: Props) {
  ...
  return (
    <OfferCardShell
      ...
      metricValue={formatDate(offer.travelDate, locale)}
      meta={[
        { label: t('cardKg'), value: `${offer.availableKg.toLocaleString()} kg` },
        { label: t('cardPrice'), value: `${offer.pricePerKg.toLocaleString()} / kg` },
      ]}
